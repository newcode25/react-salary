...
// Arquivo cedido gentilmente pelo Prof. Rafael Gomidi no bootcamp realizado
// em 2020.
...
function calculateSalaryFrom(fullSalary) {
  ...
  const percSalary = netSalary / fullSalary;

  const percINSS = discountINSS / baseINSS;

  const percIRPF = discountIRPF / baseIRPF;
